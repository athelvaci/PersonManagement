...
import com.PersonManagement.service.impl.PersonService;
...
public class PersonServiceTest {
	...
	public void testFindAll() {
		...
		assertEquals("class com.PersonManagement.service.impl.PersonService", this.personService.getClass().toString());
	}
